...
class ShowDictionaryPage extends StatefulWidget {
  @override
  ShowDictionaryPageState createState() => ShowDictionaryPageState();
}

class ShowDictionaryPageState extends State<ShowDictionaryPage> {
